...
<div class="d-flex justify-content-center align-items-center mb-5"  style="background-image: linear-gradient(to right, #6a11cb 0%, #2575fc 100%);width:100%;height:250px;">
  <h2 class="display-4 display-xs-5 font-weight-bolder text-white">:: 隱私權政策</h2>
</div>
@stop
...
<div class="container">
  <div class="row">
    ...
    <small><a href="{{ route('home') }}">:: 首頁</a> > 隱私權政策</small>
      <div class="mt-3">
      <h5 class="font-weight-bolder">隱私權政策</h5>
      </div>
      <hr>
非常歡迎您光臨殷煌國際時尚轎跑車俱樂部官方網站(以下簡稱本網站)，為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：
<br><br>
一、隱私權保護政策的適用範圍
<br><br>
...
<br><br>
2.於一般瀏覽時，伺服器會自行記錄相關行徑，包括您使用連線設備的IP位址、使用時間、使用的瀏覽器、瀏覽及點選資料記錄等，做為我們增進網站服務的參考依據，此記錄為內部應用，決不對外公布。
<br><br>
