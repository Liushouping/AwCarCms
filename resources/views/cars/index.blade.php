  ...
  <div class="col-lg-4 mb-4 tt">
    <div class="card icon-box js-tilt card-hover" data-aos="zoom-in" data-aos-delay="100">
      ...
      <div class="card-body p-3">
        ...
        <div class="d-flex justify-content-between p-0">
        <p class="card-text text-danger font-weight-bolder">＄{{$car->price}}<small class="font-weight-bolder">/Day</small><small class="text-dark font-weight-light">（ 租金 ）</small></p>
